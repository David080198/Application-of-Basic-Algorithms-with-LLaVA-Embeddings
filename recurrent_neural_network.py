...
df = pd.read_csv("llava_embeddings.csv")
df
...
def ejecucion_modelo(X, y, input_size, hidden_size, num_layers, num_classes,learning_rate,batch_size,num_epochs,porcentage):
  ...
  print(f"Entrenado modelo con {num_epochs} epocas, factor de aprendizaje {learning_rate} y porcentage del corpus {1-porcentage}")
